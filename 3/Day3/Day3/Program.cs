...
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7", 135);
		...
		private static int Compute(string input)
		{
			...
			return commonPoints.Min(x => TaxicabDistance(origin, x));
		}
		...
		private static void Verify(string wires, int expectedDistance)
		{
			Debug.Assert(Compute(wires) == expectedDistance);
		}
